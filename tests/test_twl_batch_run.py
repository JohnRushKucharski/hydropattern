"""Tests for the Great Lakes twl_batch_run.py example script.
...
SCRIPT_PATH = Path(__file__).parent.parent / "examples" / "great_lakes" / "twl_batch_run.py"
